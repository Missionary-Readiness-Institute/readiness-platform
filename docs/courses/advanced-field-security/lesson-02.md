...
# Lesson 02: Tiered Risk Management and Situational Awareness

## Key Idea

A practical way to monitor the environment and respond before crisis escalates.
...
<div class="skill-check"
     data-question="What does tentmaking training usually support?"
     data-options='['Long-term dependency', 'Sustainable local presence', 'Immediate withdrawal']'
     data-answer="1"
     data-explanation="This answer reflects the course principle for this lesson.">
</div>
